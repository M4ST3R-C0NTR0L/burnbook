"""
CybrLint Formatters - How the carnage is presented.
...
class ConsoleFormatter:
    ...
    def render(self, results: Dict[str, Any]) -> None:
        ...
        click.echo("\n" + "═" * 60)
        click.echo(click.style(
            f"  Generated by CybrLint 🔥 | {datetime.now().strftime('%Y-%m-%d %H:%M')}",
            fg="bright_black"
        ))
...
<head>
  ...
  <title>CybrLint Report — {Path(target).name}</title>
...
<div class="container">
  ...
  <footer>
    Generated by <strong>CybrLint</strong> 🔥 &nbsp;|&nbsp;
    <a href="https://github.com/cybrlint/cybrlint" style="color:#bf5fff">github.com/cybrlint/cybrlint</a>
    &nbsp;|&nbsp; MIT License
  </footer>
</div>
